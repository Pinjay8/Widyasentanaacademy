            ...
            <form action="{{ route('campaign.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <button type="button" class="btn btn-outline-primary rounded-pill quick-amount no-hover"
                            data-value="{{ $value }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex gap-3">
                        <label class="form-check-label" for="bank_bpd_bali">
                            <input class="form-check-input me-2  @error('payment_method') is-invalid @enderror"
                                type="radio" name="payment_method" id="payment_method" value="BPD BALI">
                            <img src="{{ asset('assets/img/bank-bpd-bali.png') }}" alt="BPD BALI" width="90"
                                class="img-fluid">
                        </label>
                        <label class="form-check-label" for="bank_bri">
                            <input class="form-check-input me-2 @error('payment_method') is-invalid @enderror"
                                type="radio" name="payment_method" id="payment_method" value="BRI">
                            <img src="{{ asset('assets/img/bri.png') }}" alt="BRI" width="70">
                        </label>
                ...
                <div class="d-grid mt-5">
                    <button type="submit" class="btn bg-button text-white">{{ __('messages.donation_to_payment')
                        }}</button>
                </div>
