        ...
        <div class="col-md-4">
            <div class="card border-0">
                <div class="card-body">
                    ...
                    <h4 class="text-primary">Rp. {{ number_format($campaign->collected_amount, 0, ',', '.') }}</h4>
                    ...
                    <div class="d-flex align-items-center gap-3 justify-content-center my-3">
                        ...
                        <div>
                            ...
                            <h5 class="text-muted">{{ __('messages.days_left') }}</h5>
                        </div>
                    </div>
                    ...
                    <a href="{{ route('campaign.index',['slug' => $campaign->slug]) }}"
                        class="btn btn-primary w-100 fw-medium fs-6"><i class="bi bi-heart-fill me-2"></i>{{
                        __('messages.donate') }} </a>

                    {{-- Tombol Bagikan --}}
                    <div class="d-flex gap-2 align-items-center mt-2">
                        <!-- Tombol Bagikan -->
                        <button type="button" class="btn btn-outline-primary fw-medium fs-6 w-100"
        ...
        <div class="col-md-4">
            <div class="card shadow-sm rounded-3 h-100 d-flex flex-column p-0">
                <a href="{{ route('donasi.show', $campaign->slug) }}">
                    @if($campaign->thumbnail != null)
                    <img src="{{ $campaign->thumbnail() }}" alt="Gambar Thumbnail" width="100%" class="object-fit-cover"
                        style="object-position: center; height: 168px;"
                        onerror="this.onerror=null; this.src='{{ asset('assets/img/background-placeholder.svg') }}';">
                    @else
